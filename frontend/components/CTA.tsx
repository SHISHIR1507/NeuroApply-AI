    ...
    <section ref={ref} style={{ padding: "80px 24px 140px", position: "relative", overflow: "hidden" }}>
      ...
      >
        ...
        <div style={{
          ...
          {/* Spinning conic gradient — clipped to 2px strip by parent overflow:hidden */}
          <div style={{
            position: "absolute",
            inset: "-50%",
            background: "conic-gradient(from 0deg, #f59e0b 0%, #22d3ee 30%, #22c55e 55%, #fbbf24 75%, #f59e0b 100%)",
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: "radial-gradient(circle at top left, rgba(245,158,11,0.1) 0%, transparent 70%)",
              pointerEvents: "none",
            }} />
            <div style={{
              position: "absolute", bottom: 0, right: 0, width: 220, height: 220,
              background: "radial-gradient(circle at bottom right, rgba(34,211,238,0.07) 0%, transparent 70%)",
              pointerEvents: "none",
            }} />
