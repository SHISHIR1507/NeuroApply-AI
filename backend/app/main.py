...
from app.api.routes import auth, profile, resolve, resume, feedback, chat, applications, answers, ats, support
...
app.include_router(ats.router, prefix=API_V1_PREFIX)
